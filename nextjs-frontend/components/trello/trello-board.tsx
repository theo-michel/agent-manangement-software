        ...
        setColumns(prevColumns => {
          ...
          if (targetColumnIndex !== -1) {
            ...
            if (cardIndex !== -1) {
              newColumns[targetColumnIndex].cards[cardIndex] = {
                ...newColumns[targetColumnIndex].cards[cardIndex],
                isLoading: false,
                aiResponse: `AI processed: ${response.data?.card_data?.title} - ${response.data?.card_data?.description}`
              };
            }
          }
          ...
          if (todoColumnIndex !== -1) {
            const newCard: TaskCard = {
              ...
              title: response.data?.card_data?.title || 'AI Generated Task',
              description: response.data?.card_data?.description || 'Generated by AI',
