...
import type {
  ...
  DeleteItemError,
  DeleteItemResponse,
  GetRepositoryStatusData,
  GetRepositoryStatusError,
 ...
 */
export const getRepositoryStatus = <ThrowOnError extends boolean = false>(
  options: OptionsLegacyParser<GetRepositoryStatusData, ThrowOnError>,
) => {
  return (options?.client ?? client).get<
    GetRepositoryStatusResponse,
    GetRepositoryStatusError,
 ...
 */
export const getRepositoryDocs = <ThrowOnError extends boolean = false>(
  options: OptionsLegacyParser<GetRepositoryDocsData, ThrowOnError>,
) => {
  return (options?.client ?? client).get<
    GetRepositoryDocsResponse,
    GetRepositoryDocsError,
